<template>
  ...
  <div class="relative w-full h-[786px] overflow-hidden">
    ...
    <div class="absolute inset-0 bg-black/40 flex items-center px-4 md:px-12">
      <div class="text-white max-w-2xl space-y-8">
        <h1 class="text-4xl md:text-5xl font-bold leading-tight">
          Fisioterapia Profesional 
          <span class="bg-gradient-to-r from-[#448ba9] to-[#104e75] bg-clip-text text-transparent">en tu Domicilio</span>
        </h1>
...
<div class="bg-white py-16 px-4 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto">
    <div class="text-center mb-12">
      <h2 class="text-3xl font-bold text-[#104e75] sm:text-4xl">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      <!-- Tarjeta 1 -->
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen1.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Alexandra C.</h3>
            <p class="text-xs text-[#448ba9]">Lesión lumbar</p>
          </div>
        </div>
        <p class="text-sm text-[#448ba9] line-clamp-3">
      ...
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen2.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Fernando S.</h3>
      ...
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen3.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Samuel F.</h3>
      ...
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen4.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Oscar V.</h3>
      ...
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen5.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Danitza G.</h3>
      ...
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen6.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Análiz Z.</h3>
      ...
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen7.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Carolina S.</h3>
      ...
      <div class="bg-white p-6 rounded-lg border border-[#dee3e9] shadow-sm hover:shadow-md transition-all">
        <div class="flex items-center gap-4 mb-4">
          <img src="@/assets/imagenes/imagen8.png" 
               class="w-12 h-12 rounded-full object-cover border-2 border-[#b7ebfa]">
          <div>
            <h3 class="font-semibold text-[#003157]">Roberto T.</h3>
...
<footer class="bg-gradient-to-b from-[#104e75] to-[#003157] text-[#dee3e9] pt-8 shadow-xl" id="contacto">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 pb-6 border-b border-[#b7ebfa]/20">
      ...
      <div class="space-y-3">
        <div class="flex items-center gap-2">
          <img 
            src="@/assets/imagenes/logo.jpeg" 
            alt="Fiofulnes"
            class="h-12 w-12 object-cover rounded-lg border border-[#dee3e9]/20"
          >
          <div>
            <span class="text-lg font-bold text-[#dee3e9]">Fiofulnes</span>
            <p class="text-[0.7rem] text-[#448ba9]/90 mt-0.5">Colegiados CIP N° 28456</p>
          </div>
        </div>
        <ul class="space-y-1.5 text-xs text-[#448ba9]">
      ...
      <!-- Garantías -->
      <div class="space-y-3">
        <h4 class="text-[#dee3e9] font-medium text-xs uppercase tracking-wide mb-1.5 flex items-center gap-1.5">
        ...
        <div class="space-y-2 text-xs">
          <div class="bg-[#003157]/30 p-2 rounded-md flex items-center gap-2">
            <svg class="w-4 h-4 text-[#448ba9] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            <div>
              <p class="text-[#dee3e9]">Satisfacción</p>
              <p class="text-[0.65rem] text-[#448ba9]/90">Reembolso 1ra sesión</p>
            </div>
          </div>
          <div class="bg-[#003157]/30 p-2 rounded-md flex items-center gap-2">
            <svg class="w-4 h-4 text-[#448ba9] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <p class="text-[#dee3e9]">8 Distritos</p>
              <p class="text-[0.65rem] text-[#448ba9]/90">Incluyendo JM y MF</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="space-y-2 text-xs">
          <a href="tel:+51987654321" class="flex items-center gap-2 group">
            <div class="p-1.5 bg-[#003157]/30 rounded-md group-hover:bg-[#104e75]/40 transition-colors">
              <svg class="w-4 h-4 text-[#448ba9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h18M3 12h18m-18 7h18"/>
              </svg>
            </div>
            <div>
              <p class="text-[#dee3e9]">+51 987 654 321</p>
              <p class="text-[0.65rem] text-[#448ba9]/90">Llamada/WhatsApp</p>
            </div>
          </a>
          <a href="mailto:hola@fiofulnes.com" class="flex items-center gap-2 group">
            ...
            <div>
              <p class="text-[#dee3e9]">hola@fiofulnes.com</p>
              <p class="text-[0.65rem] text-[#448ba9]/90">Respuesta en 24h</p>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="grid grid-cols-3 gap-2">
          <a href="https://wa.me/51987654321" target="_blank" class="p-2 bg-[#003157]/30 hover:bg-[#104e75]/40 rounded-md flex flex-col items-center transition-all group">
            ...
            <span class="text-[0.65rem] text-[#448ba9] group-hover:text-[#b7ebfa]">WhatsApp</span>
          </a>
          <a href="https://facebook.com" target="_blank" class="p-2 bg-[#003157]/30 hover:bg-[#104e75]/40 rounded-md flex flex-col items-center transition-all group">
            <svg class="w-5 h-5 text-[#448ba9] group-hover:text-[#b7ebfa] mb-1" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z"/>
            </svg>
            <span class="text-[0.65rem] text-[#448ba9] group-hover:text-[#b7ebfa]">Facebook</span>
          </a>
          <a href="https://instagram.com" target="_blank" class="p-2 bg-[#003157]/30 hover:bg-[#104e75]/40 rounded-md flex flex-col items-center transition-all group">
            <svg class="w-5 h-5 text-[#448ba9] group-hover:text-[#b7ebfa] mb-1" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span class="text-[0.65rem] text-[#448ba9] group-hover:text-[#b7ebfa]">Instagram</span>
          </a>
        </div>
      </div>
    </div>
    ...
    <!-- Copyright -->
    <div class="py-4 flex flex-col md:flex-row justify-between items-center gap-2 text-[0.65rem]">
      <div class="text-[#448ba9]/80 text-center order-last md:order-first">
        © 2024 Fulness - Todos los derechos reservados
      </div>
      <div class="flex items-center divide-x divide-[#104e75]">
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      const requiredFields = ['nombre', 'apellido', 'email', 'celular']
